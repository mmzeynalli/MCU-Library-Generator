...
class Function():
    def __init__(self, layout, wtype, wvisibility, wfield, wargv):

        self.layout = layout
        self.widget_type = wtype
        self.widget_vis = wvisibility
        self.widget_txt = wfield
    ...
    def get_data(self):
        ...
        self.visibility = self.widget_vis.currentText()
        self.name = self.widget_txt.text()
    ...
    def __str__(self):
        return 'Type: ' + self.type + ', Visibility: ' + self.visibility + ', Name: ' + self.name + ', argv: ' + self.argv


class Variable():
    def __init__(self, wvis, wtype, wname, wval = None):
        self.widget_vis = wvis
        self.widget_type = wtype
